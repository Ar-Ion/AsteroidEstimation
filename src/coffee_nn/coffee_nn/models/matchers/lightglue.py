...
class LightGlue(nn.Module):
    ...
    features = {
        ...
        "coffee": {
            "input_dim": 256+128+64+32,
            "descriptor_dim": 256+128+64+32
        },
    }
    ...
    def __init__(self, features="superpoint", **conf) -> None:
        ...
        if features is not None:
            ...
            # Disable weights downloading, as we are directly training
    ...
    def _forward(self, data: dict) -> dict:
        ...
        return {
            ...
            "stop": i + 1,
            "matches": matches,
            "scores": scores, # Update from mscores to scores to allow training
            "prune0": prune0,
            "prune1": prune1,
        }
